      ...
      <div className="event-details__pattern">
        <svg xmlns="http://www.w3.org/2000/svg">
          ...
          >
            ...
            <path
              d="M30,25 Q33,28 30,31 Q27,28 30,25"
              fill="none"
              stroke="#a855f7"
              strokeWidth="0.3"
            />
      ...
      <div className="event-details__container">
        ...
        <div className="event-details__header">
          <div className="event-details__header-ornament">
            ...
            <svg
              className="event-details__ornament-icon"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h2 className="event-details__title">Detalles del Evento</h2>
          ...
          {block.message1 && (
            <p className="event-details__message">{block.message2}</p>
          )}
        </div>
        ...
        <div className="event-details__cards">
          {/* Celebration */}
          <div
            className="event-details__card animate-fade-in-up"
              ...
              <div className="event-details__card-icon-wrapper">
                <div className="event-details__card-icon-container">
                  ...
                  <div className="event-details__card-icon-bg event-details__card-icon-bg--pink">
                    <svg
                      className="event-details__card-icon"
                      fill="none"
              ...
              <div className="event-details__card-info">
                <div className="event-details__card-info-item">
                  <div className="event-details__card-info-icon-wrapper">
                    <svg
                      className="event-details__card-info-icon"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      strokeWidth={1.5}
                  ...
                  <div className="flex">
                    <p className="event-details__card-info-text">
                      Te esperamos a las 6:00 pm
                    </p>

                    <p className="event-details__card-info-text event-details__card-info-text--envelope">
                      Lluvia de sobres
                    </p>
                  </div>
                </div>
                ...
                <div className="event-details__card-info-item">
                  ...
                  <p className="event-details__card-info-text event-details__card-info-text--center">
                    {block.receptionPlace}
                  </p>
                </div>
              </div>
            </div>
